...
function App() {
  ...
  return (
    ...
    {/* props : 컴포넌트끼리의 데이터 전달 방법 
      --> 속성갑을 통해서 데이터를 전달 할 수 있다 
    */}
      {/* <Menu mName="아메리카노" price="4100"></Menu> */}
    {/* 이름 : 카페라떼, 가격 : 4600 */}
      {/* <Menu mName="카페라떼" price="4600"></Menu> */}
    
    {/* <Myteam tName="교육운영부" userName="선영표"></Myteam>
    <Myteam tName="전략기획팀" userName="강예진"></Myteam>
    <Myteam tName="홍보팀" userName="임보미"></Myteam>
    <Myteam tName="기획팀" userName="최영화"></Myteam> */}
